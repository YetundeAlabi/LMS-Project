...
urlpatterns = [
    ...
    path('courses/create_course', views.CourseCreateView.as_view(), name='create_course'),
    ...
    path('courses/<slug:course_slug>/topic/<int:id>/update', views.TopicUpdateView.as_view(), name='update_topic'),
    path('courses/<slug:course_slug>/topics/', views.TopicList.as_view(), name='create_topic'),

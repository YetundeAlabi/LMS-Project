...
urlpatterns = [
    ...
    path('courses/<slug:course_slug>/topics/<uuid:pk>/update', views.TopicUpdateView.as_view(), name='update_topic'),
    path('courses/<slug:course_slug>/topics/<uuid:pk>/delete', views.TopicDeleteView.as_view(), name='delete_topic'),
    path('courses/<slug:course_slug>/topics/', views.TopicList.as_view(), name='topic_list'),
    path('courses/<slug:course_slug>/topics/<int:id>/delete', views.TopicDeleteView.as_view(), name='create_topic'),

    path('courses/<slug:course_slug>/topics/<uuid:topic_id>/subtopic/<model_name>/create/', views.SubTopicCreateUpdateView.as_view(), name='create_subtopic'),
    path('courses/<slug:course_slug>/topics/<uuid:topic_id>/subtopic/<model_name>/<int:id>/update/', views.SubTopicCreateUpdateView.as_view(), name='update_subtopic'),

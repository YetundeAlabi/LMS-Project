...
urlpatterns = [
    ...
    path('student_courses/<slug:student_course_slug>/<int:pk>/student_topics/<slug:student_topic_slug>/student_subtopics/<int:student_subtopic_id>/', views.StudentSubtopicDetailView.as_view(), name='student_subtopic_detail'),
]